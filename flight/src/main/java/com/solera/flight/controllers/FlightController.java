...
public class FlightController {
    ...
    @GetMapping(value = "/getFlight/{id}")//, consumes = "application/json", produces = "application/json")
    public ResponseEntity<?> getFlight(@PathVariable ("id") String id){//@RequestBody String id){
        try{
